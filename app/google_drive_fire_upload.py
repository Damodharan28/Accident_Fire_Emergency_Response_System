...
FOLDER_ID = '1tjVwVmKjW6k3UXk7Yz4DQ6Q3eaEfScjC'  # Replace with your folder ID
...
def save_fire_frame_to_drive(frame_image_path):
...
# image_path = '../static/accident_impact_frames/accident_frame_1.jpg'  # Replace with your actual image path
# file_url = save_fire_frame_to_drive(image_path)
